...
export const MessageContainer = ({projectId, setActiveFragment, activeFragment}: Props) => {
    ...
    return (
        <div className="flex flex-col flex-1 min-h-0">
                ...
                <div className="pt-2 pr-1">
                    {messages.map((message) => (
                        <MessageCard
                            ...
                            isActiveFramework={activeFragment?.id === message.fragment?.id}
            ...
            <div className="relative p-3 pt-1">
                <div className="absolute -top-6 left-0 right-0 h-6 bg-gradient-to-b from-transparent"></div>
